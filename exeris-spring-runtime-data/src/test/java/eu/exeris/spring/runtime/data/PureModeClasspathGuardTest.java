...
/**
 * ArchUnit guard tests for Pure Mode classpath isolation in the data module.
 *
 * <p>Ensures that data-module main classes do not depend on servlet,
...
class PureModeClasspathGuardTest {
    ...
    private static JavaClasses dataModuleClasses;

    @BeforeAll
    static void importDataModuleClasses() {
        dataModuleClasses = new ClassFileImporter()
