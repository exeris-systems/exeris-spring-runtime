---
name: exeris-spring-docs-adr-check
description: Detect documentation and ADR drift against runtime ownership and mode reality. Classifies drift (NO_ACTION / MINOR_DOC_UPDATE / DOCS_UPDATE_REQUIRED / ADR_IMPACT / NEW_ADR_REQUIRED), names affected docs, and recommends merge timing for the docs/ADR delta.
---
