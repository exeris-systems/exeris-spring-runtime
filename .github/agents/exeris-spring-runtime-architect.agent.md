...
target: vscode
user-invocable: true
tools: [read/readFile, read/problems, search/codebase, search/fileSearch, search/listDirectory, search/textSearch, search/changes, search/searchSubagent, agent/runSubagent, execute/runTests, todo, web/fetch, web/githubRepo, vscode.mermaid-chat-features/renderMermaidDiagram]
---
